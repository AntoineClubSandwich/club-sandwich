create or replace function private.is_promoter_organization(
...
revoke all on function private.is_promoter_organization(uuid)
  from public, anon, authenticated;
grant execute on function private.is_promoter_organization(uuid)
  to authenticated;
  ...
  and (
    (
      ...
      and (
        ...
        or private.is_promoter_organization(promoter_organization_id)
      )
    )
...
comment on function private.is_promoter_organization(uuid) is
  'Vérifie qu’une organisation cible est une organisation tourneur.';
